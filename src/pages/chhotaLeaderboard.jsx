...
const ChhotaLeaderboard = () => {
  ...
  // Sample static data for 20 participants
  const participants = [
  ...
  return (
    <div className="bg-gray-100 p-8">
      ...
      <div className="relative">
        <button
          onClick={() => scroll("left")}
          className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-blue-800 text-white rounded-full p-2 shadow-lg"
        >
          <FaArrowLeft />
        </button>
        <div
        ...
        >
          {participants.map((participant, index) => (
            <div
              key={index}
              className="min-w-[250px] max-w-[250px] bg-blue-100 p-4 rounded-lg shadow-md flex-shrink-0"
        ...
        <button
          ...
          className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-blue-800 text-white rounded-full p-2 shadow-lg"
        >
          <FaArrowRight />
        </button>
      </div>
