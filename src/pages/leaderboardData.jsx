...
import ChhotaLeaderboard from './chhotaLeaderboard'; // Capitalize the component name
...
const Leaderboard = () => {
  return (
    <div className="container mx-auto my-10 p-5 bg-white shadow-md rounded-lg">
      <h1 className="text-3xl font-bold text-blue-800 mb-6 text-center">Leaderboard</h1>
      ...
      <div className="mt-10">
        <ChhotaLeaderboard /> {/* Use the capitalized component name */}
      </div>
    </div>
  );
};
