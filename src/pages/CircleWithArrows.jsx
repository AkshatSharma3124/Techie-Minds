  ...
  return (
    <section className="relative flex flex-col items-center py-16">
      <div className="relative w-[600px] h-[600px] flex justify-center items-center">
        {/* Central Circle */}
        <CentralCircle text="PathFinder" top={70} left={50} />

        {/* Feature Circles */}
        <FeatureCircle text="Counselling" angle={120} distance={220} />
        <FeatureCircle text="Best Resources" angle={255} distance={420} />
        <FeatureCircle text=" RoadMap" angle={340} distance={320} />
      </div>
    </section>
  );
};
